...
import { Search, Plus, ThumbsUp, MessageCircle, Clock, Home, User, ChevronUp, ChevronDown } from 'lucide-react'
...
export default function WooriQAPlatform() {
  ...
  const allQuestions = [
    {
      ...
      category: "프로젝트",
      title: "프로젝트 진행 상황",
      content: "현재 진행 중인 프로젝트에서 팀원들과의 협업 방식에 대해 궁금한 점이 있습니다.",
      likes: 12,
      comments: 5,
      timeAgo: "2시간 전"
    },
    ...
    },
    {
      ...
      content: "신입 개발자로서 포트폴리오를 어떻게 구성해야 할지 조언을 구합니다.",
      likes: 15,
      comments: 7,
      timeAgo: "5시간 전"
    },
    ...
    },
    {
      ...
      category: "프로젝트",
      title: "데이터베이스 설계 질문",
      content: "사용자 관리 시스템의 데이터베이스를 설계하고 있는데 조언이 필요합니다.",
      likes: 20,
      comments: 12,
      timeAgo: "1일 전"
    },
    ...
    },
    {
      ...
      content: "RESTful API를 설계할 때 지켜야 할 베스트 프랙티스가 궁금합니다.",
      likes: 22,
      comments: 11,
      timeAgo: "3일 전"
    },
    {
      ...
      category: "자유",
      title: "개발자 성장 경험담",
      content: "주니어에서 시니어로 성장하면서 겪었던 경험을 공유하고 싶습니다.",
      likes: 30,
      comments: 18,
      timeAgo: "4일 전"
    },
    ...
    },
    {
      ...
      content: "JavaScript의 고급 개념들을 학습할 수 있는 자료를 찾고 있습니다.",
      likes: 16,
      comments: 10,
      timeAgo: "5일 전"
    }
  ...
  const currentQuestions = sortedQuestions.slice(startIndex, startIndex + postsPerPage)
      ...
      <header className="bg-[#0074c9] text-white sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" className="text-white hover:text-blue-100 hover:bg-white/10">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-bold text-white">DevQ&A</h1>
            </div>
            
            {/* Right - Write Button & Profile */}
            <div className="flex items-center gap-4">
              <Button className="bg-white text-[#0074c9] hover:bg-gray-50">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="w-8 h-8 rounded-full p-0 text-white hover:text-blue-100 hover:bg-white/10">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4 mb-8">
          {currentQuestions.map((question) => (
            <Card key={question.id} className="hover:shadow-md transition-shadow cursor-pointer border border-gray-200">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-6 text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm font-medium">{question.comments} 댓글</span>
                  </div>
                </div>
              </CardContent>
            </Card>
