        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="mb-4 p-3 bg-red-900/50 rounded text-red-400 font-mono text-sm">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label
                                htmlFor="id"
                                className="block text-sm font-pixel mb-2"
                            >
                                User ID
                            </label>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                ...
                                className="text-sm font-mono text-green-400 hover:text-green-300 underline"
                            >
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        <Button
                            type="submit"
                            disabled={
                                isLoading || !formData.id || !formData.password
                            }
